...
public:
	...
	using ParamaterList = dev::solidity::test::ParameterList;

	TestFunctionCall(FunctionCall _call): m_call(_call) {}
	...
	FunctionCall call() const { return m_call; }
...
private:
	...
	std::string m_output = std::string{};
	bool m_failure = true;
};
